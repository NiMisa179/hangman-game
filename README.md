...
The dictionary of the game is provided by API. When called, a random word is stored in the variable word. If there is an error when API called, the error is printed and the variable word is empty.
...
The user cannot type the same letter more than one time, whenever this is a right or a wrong guess.
